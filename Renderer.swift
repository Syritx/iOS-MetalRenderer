...
class Renderer: NSObject, MTKViewDelegate {
    ...
    init?(mtkView: MTKView) {
        ...
        let vertices = [Vertex(color: [Float.random(in: 0..<1), Float.random(in: 0..<1), Float.random(in: 0..<1), 1], pos: [-1, -1]),
                        Vertex(color: [Float.random(in: 0..<1), Float.random(in: 0..<1), Float.random(in: 0..<1), 1], pos: [0,   1]),
                        Vertex(color: [Float.random(in: 0..<1), Float.random(in: 0..<1), Float.random(in: 0..<1), 1], pos: [1,  -1])]
